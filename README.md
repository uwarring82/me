...
work. The page is hosted on GitHub Pages and requires no build step — it is
plain HTML and CSS served directly.
...
The portrait is sourced from the University of Freiburg group page. It is not
covered by the MIT licence below — see the licensing note.
